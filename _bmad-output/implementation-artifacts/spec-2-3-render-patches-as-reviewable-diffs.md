...
**Commands:**
- `pnpm --filter @a11yfix/web test` -- expected: all suites pass, including the new `diff-viewer.test.tsx` and the unchanged translate regression suites.
